...
public class LoginActivity_TuDC extends AppCompatActivity {
...
//        }
        ...
        tvGoRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(LoginActivity_TuDC.this, RegisterActivity_TuDC.class));
            }
        });
        ...
        auth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(LoginActivity_TuDC.this, "Đăng nhập thành công", Toast.LENGTH_LONG).show();
                    startActivity(new Intent(LoginActivity_TuDC.this, HomeActivity_TuDC.class));
                } else {
                    progressDialog.dismiss();
                    Toast.makeText(LoginActivity_TuDC.this, "Đăng nhập thất bại", Toast.LENGTH_LONG).show();
