        ...
        auth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(RegisterActivity_TuDC.this, "Đăng ký thành công", Toast.LENGTH_LONG).show();
                    startActivity(new Intent(RegisterActivity_TuDC.this, LoginActivity_TuDC.class));
                } else {
                    progressDialog.dismiss();
                    Toast.makeText(RegisterActivity_TuDC.this, "Đăng ký thất bại", Toast.LENGTH_LONG).show();
